        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <img style="width: 800px" src="{{asset('images/otp.jpg')}}" alt="IMG">
                </div>
                <form class="login100-form validate-form"  id="otpForm" action="{{ route('verification') }}"  method="post">
                @csrf <!-- {{ csrf_field() }} -->
                    <div class="login100-pic js-tilt" data-tilt>
                    ...
                    <div class="container-login100-form-btn">
                        <button style="background-color: rgb(6, 6, 102)" type="submit" class="login100-form-btn buttonload" id = "btnSubmit" onclick = "return Otp()" >
                            Submit
                        </button>
                </form>
                <div class="text-center p-t-12">
                        ...
                        <a class="txt2" href="{{ route('reverify')}}">
                        OTP?
                        </a>
                    </div>
