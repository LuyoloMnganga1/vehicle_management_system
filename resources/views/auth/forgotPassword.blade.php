...
<head>
    <title>Forgot Password - Vehicle  App</title>
    <meta charset="UTF-8">
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" id="fogortForm" action="{{ route('forget-password')}}"  method="GET">
                @csrf <!-- {{ csrf_field() }} -->
                <div class="login100-pic js-tilt" data-tilt>
                    ...
                    <div class="container-login100-form-btn">
                        <button style="background-color: rgb(6, 6, 102)" type="submit" class="login100-form-btn buttonload" id = "btnSubmit" onclick = "return fogort()">
