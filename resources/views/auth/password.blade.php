...
<head>
    <title>Set Password - Vehicle  App</title>
    <meta charset="UTF-8">
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" id="passwordForm" action="{{ route('password', $item->id)}}"  method="post">
                @csrf <!-- {{ csrf_field() }} -->
                <div class="login100-pic js-tilt" data-tilt>
                    ...
                    <small>Please fill this form to set your password. </small>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        <input class="input100" type="text" name="email" value = "{{ $item->email}}" placeholder="Email">
                    ...
                    <div class="container-login100-form-btn">
                        <button style="background-color: rgb(6, 6, 102)" type="submit" class="login100-form-btn buttonload" id = "btnSubmit" onclick = "return password()">
                            Set Password
                        </button>
                    </div>
